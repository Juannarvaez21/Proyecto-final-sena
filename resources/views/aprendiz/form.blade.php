...
<div class="fond">
    <div class="col-md-12">
        ...
        <div class="card-circle">
            ...
            <input type="text" name="documento" class="form-control @error('documento') is-invalid @enderror" value="{{ old('documento', $aprendiz?->documento) }}" id="documento" placeholder="documento">
    ...
    <label for="pregunta1" class="form-label">
        ...
        <strong> Gestion Del Tiempo</strong>
    </label>
